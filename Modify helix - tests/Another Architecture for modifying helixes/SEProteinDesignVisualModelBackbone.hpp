...
public:
	...
	void addNode(SEProteinDesignNodeConstructionPoint* pathNodeConstruction);
	void removeNode(SEProteinDesignNodeConstructionPoint* pathNodeConstruction);
	SEProteinDesignNodeConstructionPoint* last();
	SEProteinDesignNodeConstructionPoint* first();

	// getters and setters for the current begin and end points
...
private:
	...
	SBPointerList<SEProteinDesignNodeConstructionPoint> BeginList;
