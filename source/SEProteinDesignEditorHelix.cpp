...
//            SEProteinDesignVisualModelBackbone VM = *path;
//            SEProteinDesignVisualModelBackbone* ptr = &VM;
//            helixList.push_back(static_cast<SEProteinDesignVisualModelBackbone*>(ptr));
